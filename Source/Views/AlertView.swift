class AlertView: AlertControllerView {
    ...
    private func createTextFieldsConstraints() {
        ...
        self.pinBottomOfScrollView(to: textFieldsView, withPriority: UILayoutPriority.defaultLow + 2)
    }
    ...
    private func createCustomContentViewConstraints() {
        ...
        self.pinBottomOfScrollView(to: self.contentView, withPriority: UILayoutPriority.defaultLow + 3)
    }
